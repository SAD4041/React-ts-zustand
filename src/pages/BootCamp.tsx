  ...
  const schedule = [
    {
      ...
      time: "09:00 - 15:00",
      sessions: [
        { time: "09:00 - 10:30", title: "مرحب و معرفی (پرتو: دکتر رضایی)", type: "introduction" },
        { time: "10:45 - 12:15", title: "مبانی الگوریتم‌ها (پرتو: دکتر رضایی)", type: "lecture" },
        { time: "13:00 - 15:00", title: "تمرین عملی و حل مسائل", type: "practice" },
      ],
    },
    {
      day: "روز دوم",
      ...
      time: "09:00 - 15:00",
      sessions: [
        { time: "09:00 - 10:30", title: "ساختمان‌های داده پایه (پرتو: مهندس احمدی)", type: "lecture" },
        { time: "10:45 - 12:15", title: "درخت‌ها و گراف (پرتو: مهندس احمدی)", type: "lecture" },
        { time: "13:00 - 15:00", title: "تمرین‌های عملی پیشرفته", type: "practice" },
      ],
    },
    {
      day: "روز سوم",
      ...
      time: "09:00 - 15:00",
      sessions: [
        { time: "09:00 - 10:30", title: "برنامه‌ریزی پویا (پرتو: دکتر رضایی)", type: "lecture" },
        { time: "10:45 - 12:15", title: "الگوریتم‌های گراف (پرتو: دکتر رضایی)", type: "lecture" },
        { time: "13:00 - 15:00", title: "کارگاه عملی و مسائل چالشی", type: "workshop" },
      ],
    },
    {
      day: "روز چهارم",
      ...
      time: "09:00 - 17:00",
      sessions: [
        { time: "09:00 - 10:30", title: "مرور و نکات حیاتی (پرتو: دکتر زهرا)", type: "review" },
        { time: "10:45 - 17:00", title: "مسابقه تیمی و ارزیابی نهایی", type: "competition" },
      ],
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#00274D] via-[#003D6B] to-[#00274D] text-white" dir="rtl">
      ...
      <div className="py-20 container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300">متخصصانی با تجربه گسترده در برنامه‌نویسی رقابتی</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {instructors.map((instructor, index) => (
            ...
            >
              ...
              <p className="text-[#FFD500] text-sm font-semibold mb-2">{instructor.role}</p>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 mb-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h4 className="text-2xl font-bold mb-2">{schedule[selectedDay].day}</h4>
              ...
              <div className="space-y-4">
                {schedule[selectedDay].sessions.map((session, idx) => (
                  <div key={idx} className="flex gap-4">
                    <div className={`flex-shrink-0 px-4 py-2 bg-gradient-to-br ${getSessionColor(session.type)} rounded-lg text-sm font-semibold text-[#00274D]`}>
                      {session.time}
                    </div>
            ...
            <div className="bg-gradient-to-br from-[#FFD500]/20 to-[#FFD500]/5 backdrop-blur-md border border-[#FFD500]/30 rounded-3xl p-12">
              ...
              <div className="space-y-6 mb-8">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-3xl font-bold text-[#FFD500]">رایگان</span>
                  </div>
                  <p className="text-sm text-gray-400">شامل تمام جلسات و منابع آموزشی</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 text-center">
                    ...
                    <div className="text-2xl font-bold text-[#46BEF6]">100 نفر</div>
                  </div>
                  <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 text-center">
                    <div className="text-sm text-gray-300 mb-2">مهلت ثبت‌نام</div>
                    <div className="text-2xl font-bold text-[#D7263D]">30 بهمن</div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-white/5 rounded-xl border border-white/10">
                <p className="text-xs text-gray-400 text-center">
                  ...
                  <a href="/signup" className="text-[#FFD500] hover:text-white transition-colors">
                    {" "}اینجا ثبت‌نام کنید
                  </a>
                </p>
              </div>
