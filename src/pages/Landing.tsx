...
function ICPCLanding() {
  ...
  const rules = [
    ...
    },
    {
      ...
      description:
         " تمام ارسال‌ها توسط داور خودکار بررسی می‌شود و نتیجه داوری نهایی و غیرقابل‌تغییر است. زمان و تعداد ارسال‌ها روی امتیاز نهایی تأثیر دارد. رده‌بندی لحظه‌ای نمایش داده می‌شود اما 1 ساعت انتهایی فریز خواهد شد",
      icon: ClipboardCheck,
      color: "#00BFFF",
    },
    {
