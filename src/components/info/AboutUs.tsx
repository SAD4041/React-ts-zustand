    ...
    <div className="py-16 bg-white">
      ...
      <div className="container mx-auto px-4 mb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center bg-[#4ABBEB] text-white px-6 py-2 rounded-full mb-6">
            درباره ما
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-100 via-cyan-100 to-gray-100 py-8 mb-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            {stats.map((s, i) => (
              <div key={i}>
                <div className="text-xl font-bold text-[#4ABBEB] mb-1">{s.number}</div>
                <div className="text-[#4ABBEB] text-xs font-medium">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-10">
          {team.slice(0, 4).map((member, index) => (
            ...
            >
              <div className="bg-gray-200 h-32 rounded-t-3xl flex items-center justify-center">
